package com.raquo.cycle.xstream.run

import com.raquo.cycle.base._
...
object XStreamRun {
  ...
  private def combineDrivers(drivers: Seq[Driver[_, _, _, _]]): RawDrivers = {
    // @TODO this does not compile in Scala 2.12 – figure out why
    // [error]  found   : sink.type (with underlying type _$25)
    // [error]  required: _$25
    // [error]       (driver.key, js.Any.fromFunction3(driver.driverFunction))
    // [error]                                                ^
